...
- **Logos officiels**: Utiliser exclusivement `overnode_logo.png` et `overnode_icon.png` dans l'interface interne. L'icône officielle de l'application (Dock, Finder, dossier Applications) est `AppIcon.icns` avec fond sombre `#1a1d25` (rgba(26, 29, 37)) et nuage blanc centré.
