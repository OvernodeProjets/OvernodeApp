    ...
    static func dictionary(for language: AppLanguage) -> [String: String] {
        ...
        case .french:
            return [
                ...
                "auth_passkey_notice": "La clé d'accès (Passkey) est configurée directement sur console.overnode.fr.",
        ...
        case .english:
            return [
                ...
                "auth_passkey_notice": "Passkeys are configured directly on console.overnode.fr.",
